...
__all__ = ['se_airx26', 'se_airx50', 'se_airx101', 'se_airx152']
...
def se_airx26(baseWidth=4, cardinality=32):
    """
    Construct SE-AIRX-26.
    """
...
def se_airx101(baseWidth=4, cardinality=32):
    """
    Construct SE-AIRX-101, 200 layers.
    """
    model = SE_AIRX(baseWidth, cardinality, [3, 4, 23, 3], 1000)
    return model

def se_airx152(baseWidth=4, cardinality=32):
    """
    Construct SE-AIRX-152, 302 layers.
    """
