...
class Aligned_Inception_ResNeXt(nn.Module):
    def __init__(self, baseWidth, cardinality, layers, num_classes):
        ...
        """
        super(Aligned_Inception_ResNeXt, self).__init__()
...
def aligned_inception_resnext50(baseWidth=4, cardinality=32):
    """
    Construct Aligned_Inception_ResNeXt-50.
    """
    model = Aligned_Inception_ResNeXt(baseWidth, cardinality, [3, 4, 6, 3], 1000)
    return model


def aligned_inception_resnext101(baseWidth=4, cardinality=32):
    """
